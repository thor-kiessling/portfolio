...
def main():
    ...
    # objective([2840.0, 9298.0, 0.017827669316850668, 34.460210858480579, 9991.9591180734624], data=data, size=minutes_train, train=True, plot=True) # cand2
    # test_result = objective([2840.0, 9298.0, 0.017827669316850668, 34.460210858480579, 9991.9591180734624], data=data, size=minutes_train, train=False, plot=True)
