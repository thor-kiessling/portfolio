...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "motif_matching_knn",
        "sources": [
            "motif_matching_knn.pyx"
        ]
    },
    "module_name": "motif_matching_knn"
}
END: Cython Metadata */
...
#define __PYX_HAVE__motif_matching_knn
#define __PYX_HAVE_API__motif_matching_knn
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
struct __pyx_opt_args_18motif_matching_knn_find_matches;

/* "motif_matching_knn.pyx":78
...
/* Module declarations from 'motif_matching_knn' */
...
static __Pyx_memviewslice __pyx_f_18motif_matching_knn_zNormalize(__Pyx_memviewslice); /*proto*/
static double __pyx_f_18motif_matching_knn__sum(__Pyx_memviewslice, int); /*proto*/
static __Pyx_memviewslice __pyx_f_18motif_matching_knn_find_matches(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch, struct __pyx_opt_args_18motif_matching_knn_find_matches *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "motif_matching_knn"
int __pyx_module_is_main_motif_matching_knn = 0;

/* Implementation of 'motif_matching_knn' */
...
static PyObject *__pyx_pf_18motif_matching_knn_find_matches(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_T, __Pyx_memviewslice __pyx_v_Q, int __pyx_v_knn, int __pyx_v_sample_rate); /* proto */
...
static __Pyx_memviewslice __pyx_f_18motif_matching_knn_zNormalize(__Pyx_memviewslice __pyx_v_my_time_series) {
  int __pyx_v_index;
  int __pyx_v_length;
  ...
  __Pyx_RefNannySetupContext("zNormalize", 0);
  __Pyx_TraceCall("zNormalize", __pyx_f[0], 12, 0, __PYX_ERR(0, 12, __pyx_L1_error));

  /* "motif_matching_knn.pyx":20
 * 
 ...
 */
  __pyx_v_length = (__pyx_v_my_time_series.shape[0]);

  /* "motif_matching_knn.pyx":23
 *     cdef int length = my_time_series.shape[0]
 *     # print(length)
 *     cdef double[:,] data = np.zeros(length) # last bit of python doesnt matter only called once             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_mean = (__pyx_f_18motif_matching_knn__sum(__pyx_v_my_time_series, __pyx_v_length) / __pyx_v_length);

  /* "motif_matching_knn.pyx":36
 *     # print(my_time_series[1:length])
 * 
 *     while index < length:             # <<<<<<<<<<<<<<
 ...
 */
  while (1) {
    __pyx_t_7 = ((__pyx_v_index < __pyx_v_length) != 0);
    if (!__pyx_t_7) break;

    /* "motif_matching_knn.pyx":37
 * 
 *     while index < length:
 *         data[index] = (my_time_series[index] - mean) ** 2             # <<<<<<<<<<<<<<
 *         index += 1
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_9 * __pyx_v_data.strides[0]) )) = pow(((*((double *) ( /* dim=0 */ (__pyx_v_my_time_series.data + __pyx_t_8 * __pyx_v_my_time_series.strides[0]) ))) - __pyx_v_mean), 2.0);

    /* "motif_matching_knn.pyx":38
 *     while index < length:
 *         data[index] = (my_time_series[index] - mean) ** 2
 *         index += 1             # <<<<<<<<<<<<<<
 *     cdef double sum_squares = _sum(data, length)
 ...
 */
  __pyx_v_sum_squares = __pyx_f_18motif_matching_knn__sum(__pyx_v_data, __pyx_v_length);

  /* "motif_matching_knn.pyx":41
 *     cdef double sum_squares = _sum(data, length)
 *     # sum_squares = sum((x - mean)**2 for x in my_time_series)
 *     cdef double deviation = (sum_squares/ length) ** .5             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_deviation = pow((__pyx_v_sum_squares / __pyx_v_length), .5);

  /* "motif_matching_knn.pyx":49
 *     # print(data.base)
 * 
 *     index = 0             # <<<<<<<<<<<<<<
 *     while index < length:
 ...
 */
    ...
    *((double *) ( /* dim=0 */ (__pyx_v_my_time_series.data + __pyx_t_11 * __pyx_v_my_time_series.strides[0]) )) = (((*((double *) ( /* dim=0 */ (__pyx_v_my_time_series.data + __pyx_t_10 * __pyx_v_my_time_series.strides[0]) ))) - __pyx_v_mean) / __pyx_v_deviation);

    /* "motif_matching_knn.pyx":53
 *         # print("setting data =", (my_time_series[index] - mean) / deviation)
 *         my_time_series[index] = (my_time_series[index] - mean) / deviation
 *         index += 1             # <<<<<<<<<<<<<<
 *     # print("after norm", str(_sum(my_time_series, length)/length), str(my_time_series[length-1]), str(mean), str(deviation))
 ...
 */
  __PYX_INC_MEMVIEW(&__pyx_v_my_time_series, 0);
  __pyx_r = __pyx_v_my_time_series;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("motif_matching_knn.zNormalize", __pyx_clineno, __pyx_lineno, __pyx_filename);
...
static double __pyx_f_18motif_matching_knn__sum(__Pyx_memviewslice __pyx_v_item, int __pyx_v_size) {
  int __pyx_v_i;
  double __pyx_v_ret;
  double __pyx_r;
  __Pyx_TraceDeclarations
  ...
  __Pyx_TraceCall("_sum", __pyx_f[0], 60, 1, __PYX_ERR(0, 60, __pyx_L1_error));

  /* "motif_matching_knn.pyx":61
 * 
 * cdef double _sum(double[:,] item, int size) nogil:
 *     cdef int i = 0             # <<<<<<<<<<<<<<
 *     # cdef int size = 0
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    __pyx_v_ret = (__pyx_v_ret + (*((double *) ( /* dim=0 */ (__pyx_v_item.data + __pyx_t_3 * __pyx_v_item.strides[0]) ))));
  }

  /* "motif_matching_knn.pyx":67
 *     for i in range(size):
 *         ret += item[i]
 *     return ret             # <<<<<<<<<<<<<<
 * # DTYPE = np.double
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("motif_matching_knn._sum", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_18motif_matching_knn_1find_matches(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_18motif_matching_knn_find_matches(__Pyx_memviewslice __pyx_v_T, __Pyx_memviewslice __pyx_v_Q, int __pyx_v_knn, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_18motif_matching_knn_find_matches *__pyx_optional_args) {
  int __pyx_v_sample_rate = ((int)1);
  double __pyx_v_bestSoFar;
  int __pyx_v_length;
  int __pyx_v_count;
  int __pyx_v_m;
  ...
  __Pyx_memviewslice __pyx_v_nn_dist = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_j;
  double __pyx_v_dist;
  double __pyx_v_u;
  double __pyx_v_sdev;
  int __pyx_v_knn_pos;
  int __pyx_v_knn_pos_plus;
  int __pyx_v_loc;
  int __pyx_v_i;
  double __pyx_v_tnext;
  int __pyx_v_hasNext;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_TraceCall("find_matches", __pyx_f[0], 78, 0, __PYX_ERR(0, 78, __pyx_L1_error));
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_AsDouble(__pyx_n_s_inf); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 83, __pyx_L1_error)
  __pyx_v_bestSoFar = __pyx_t_1;

  /* "motif_matching_knn.pyx":84
 * 
 *     cdef double bestSoFar = float("inf")
 *     cdef int length = T.shape[0]             # <<<<<<<<<<<<<<
 *   # print("initialized bestsofar as " + str(bestSoFar))
 ...
 */
  __pyx_v_length = (__pyx_v_T.shape[0]);

  /* "motif_matching_knn.pyx":86
 *     cdef int length = T.shape[0]
 *   # print("initialized bestsofar as " + str(bestSoFar))
 *     cdef int count = 0  # the 'step' in the time series             # <<<<<<<<<<<<<<
 *     Q = zNormalize(Q)
 ...
 */
  __pyx_t_2 = __pyx_f_18motif_matching_knn_zNormalize(__pyx_v_Q); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 87, __pyx_L1_error)
  __PYX_XDEC_MEMVIEW(&__pyx_v_Q, 1);
  __pyx_v_Q = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "motif_matching_knn.pyx":89
 *     Q = zNormalize(Q)
 *     # cdef int length = T.shape[0]
 *     cdef int m = Q.shape[0]             # <<<<<<<<<<<<<<
 ...
 *     cdef double ex = 0
 */
  __pyx_v_m = (__pyx_v_Q.shape[0]);

  /* "motif_matching_knn.pyx":90
 *     # cdef int length = T.shape[0]
 *     cdef int m = Q.shape[0]
 *     cdef double[:,] X = np.zeros(m)             # <<<<<<<<<<<<<<
 *     cdef double ex = 0
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 90, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  if (!__pyx_t_6) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 90, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    #if CYTHON_FAST_PYCALL
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_3);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_knn); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = NULL;
  ...
  if (!__pyx_t_4) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_7, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_7)) {
      ...
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_7)) {
      PyObject *__pyx_temp[2] = {__pyx_t_4, __pyx_t_5};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_7, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_5 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_6, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 95, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyInt_From_int(__pyx_v_knn); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_5 = NULL;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_nn_dist = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "motif_matching_knn.pyx":97
 *     cdef double[:,] nn = np.zeros(knn)
 *     cdef double[:,] nn_dist = np.zeros(knn)
 *     cdef int j = 0             # <<<<<<<<<<<<<<
 *     # print("executed up to here2")
 ...
 *         knn_pos_plus = 1
 */
  __pyx_v_knn_pos_plus = 0;

  /* "motif_matching_knn.pyx":106
 *     cdef int knn_pos = 0
 *     cdef int knn_pos_plus = 0
 *     if knn > 1:             # <<<<<<<<<<<<<<
 *         knn_pos_plus = 1
 *     cdef int loc
 */
  __pyx_t_8 = ((__pyx_v_knn > 1) != 0);
  if (__pyx_t_8) {

    /* "motif_matching_knn.pyx":107
 *     cdef int knn_pos_plus = 0
 *     if knn > 1:
 *         knn_pos_plus = 1             # <<<<<<<<<<<<<<
 *     cdef int loc
 ...
 */
  ...
  __pyx_v_tnext = (*((double *) ( /* dim=0 */ (__pyx_v_T.data + __pyx_t_9 * __pyx_v_T.strides[0]) )));

  /* "motif_matching_knn.pyx":114
 *     # print("entering main loop")
 *     tnext = T[count]
 *     hasNext = True             # <<<<<<<<<<<<<<
 *     # nn[0] = 4000
 ...
 */
  while (1) {
    __pyx_t_8 = (__pyx_v_hasNext != 0);
    if (!__pyx_t_8) break;

    /* "motif_matching_knn.pyx":118
 *     # return nn
 *     while hasNext:  # can choose to limit the depth you look into the TS with "and count < 100000:"
 *         count += 1             # <<<<<<<<<<<<<<
 *         if count % sample_rate == 0:
 ...
 *             i = int(i)
 */
    __pyx_t_8 = (((__pyx_v_count % __pyx_v_sample_rate) == 0) != 0);
    if (__pyx_t_8) {

      /* "motif_matching_knn.pyx":120
 *         count += 1
 *         if count % sample_rate == 0:
 *             i = count / sample_rate % m             # <<<<<<<<<<<<<<
 *             i = int(i)
 ...
 */
      __pyx_v_i = ((__pyx_v_count / __pyx_v_sample_rate) % __pyx_v_m);

      /* "motif_matching_knn.pyx":121
 *         if count % sample_rate == 0:
 *             i = count / sample_rate % m
 *             i = int(i)             # <<<<<<<<<<<<<<
 *             # print("entered main loop")
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_10 * __pyx_v_X.strides[0]) )) = __pyx_v_tnext;

      /* "motif_matching_knn.pyx":124
 *             # print("entered main loop")
 *             X[i] = tnext  # circular buffer to store current subsequence.
 *             ex = ex + X[i]  # iteratively sum up values to use for the mean             # <<<<<<<<<<<<<<
 *             ex2 = ex2 + X[i] ** 2  # sum up squared values to use for sdev
 ...
 */
      ...
      __pyx_v_ex = (__pyx_v_ex + (*((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_11 * __pyx_v_X.strides[0]) ))));

      /* "motif_matching_knn.pyx":125
 *             X[i] = tnext  # circular buffer to store current subsequence.
 *             ex = ex + X[i]  # iteratively sum up values to use for the mean
 *             ex2 = ex2 + X[i] ** 2  # sum up squared values to use for sdev             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_v_ex2 = (__pyx_v_ex2 + pow((*((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_12 * __pyx_v_X.strides[0]) ))), 2.0));

      /* "motif_matching_knn.pyx":127
 *             ex2 = ex2 + X[i] ** 2  # sum up squared values to use for sdev
 * 
 *             if count >= m - 1:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_8 = ((__pyx_v_count >= (__pyx_v_m - 1)) != 0);
      if (__pyx_t_8) {

        /* "motif_matching_knn.pyx":129
 *             if count >= m - 1:
 *                 # print("entering distance calc")
 *                 u = ex / m  # u is mu, or the mean             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_u = (__pyx_v_ex / __pyx_v_m);

        /* "motif_matching_knn.pyx":131
 *                 u = ex / m  # u is mu, or the mean
 * 
 *                 sdev = abs(ex2 / m - u ** 2) ** (0.5)             # <<<<<<<<<<<<<<
 *                 j = 0
 *                 dist = 0
 */
        __pyx_v_sdev = pow(fabs(((__pyx_v_ex2 / __pyx_v_m) - pow(__pyx_v_u, 2.0))), 0.5);

        /* "motif_matching_knn.pyx":132
 * 
 *                 sdev = abs(ex2 / m - u ** 2) ** (0.5)
 *                 j = 0             # <<<<<<<<<<<<<<
 *                 dist = 0
 ...
 */
        while (1) {
          __pyx_t_13 = ((__pyx_v_j < __pyx_v_m) != 0);
          if (__pyx_t_13) {
          } else {
            __pyx_t_8 = __pyx_t_13;
            goto __pyx_L10_bool_binop_done;
          }
          __pyx_t_13 = ((__pyx_v_dist < __pyx_v_bestSoFar) != 0);
          __pyx_t_8 = __pyx_t_13;
          __pyx_L10_bool_binop_done:;
          if (!__pyx_t_8) break;

          /* "motif_matching_knn.pyx":138
 *                 while j < m and dist < bestSoFar:
 * 
 *                     dist = dist + (Q[j] - (X[(i + j) % m] - u) / sdev) ** 2             # <<<<<<<<<<<<<<
 *                     # if dist == np.nan:
 ...
 */
          ...
          __pyx_t_15 = ((__pyx_v_i + __pyx_v_j) % __pyx_v_m);
          __pyx_v_dist = (__pyx_v_dist + pow(((*((double *) ( /* dim=0 */ (__pyx_v_Q.data + __pyx_t_14 * __pyx_v_Q.strides[0]) ))) - (((*((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_15 * __pyx_v_X.strides[0]) ))) - __pyx_v_u) / __pyx_v_sdev)), 2.0));

          /* "motif_matching_knn.pyx":144
 * 
 * 
 *                     j = j + 1             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_8 = ((__pyx_v_dist < __pyx_v_bestSoFar) != 0);
        if (__pyx_t_8) {

          /* "motif_matching_knn.pyx":148
 *                 if dist < bestSoFar:
 *                     # bestSoFar = dist
 *                     loc = count - m  # count gives the end of the matched motif. Move m spaces back to finds its head.             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_v_loc = (__pyx_v_count - __pyx_v_m);

          /* "motif_matching_knn.pyx":151
 * 
 *                   # print("inserting best" +str(loc)+ " "+ str(knn_pos))
 *                     nn[knn_pos] = loc             # <<<<<<<<<<<<<<
 ...
 */
          __pyx_t_16 = __pyx_v_knn_pos;
          *((double *) ( /* dim=0 */ (__pyx_v_nn.data + __pyx_t_16 * __pyx_v_nn.strides[0]) )) = __pyx_v_loc;

          /* "motif_matching_knn.pyx":152
 *                   # print("inserting best" +str(loc)+ " "+ str(knn_pos))
 *                     nn[knn_pos] = loc
 *                     nn_dist[knn_pos] = dist             # <<<<<<<<<<<<<<
 *                     bestSoFar = nn_dist[knn_pos_plus]
 *                     if bestSoFar == 0 :
 */
          __pyx_t_17 = __pyx_v_knn_pos;
          *((double *) ( /* dim=0 */ (__pyx_v_nn_dist.data + __pyx_t_17 * __pyx_v_nn_dist.strides[0]) )) = __pyx_v_dist;

          /* "motif_matching_knn.pyx":153
 *                     nn[knn_pos] = loc
 *                     nn_dist[knn_pos] = dist
 *                     bestSoFar = nn_dist[knn_pos_plus]             # <<<<<<<<<<<<<<
 *                     if bestSoFar == 0 :
 ...
 */
          __pyx_t_18 = __pyx_v_knn_pos_plus;
          __pyx_v_bestSoFar = (*((double *) ( /* dim=0 */ (__pyx_v_nn_dist.data + __pyx_t_18 * __pyx_v_nn_dist.strides[0]) )));

          /* "motif_matching_knn.pyx":154
 *                     nn_dist[knn_pos] = dist
 *                     bestSoFar = nn_dist[knn_pos_plus]
 *                     if bestSoFar == 0 :             # <<<<<<<<<<<<<<
 *                         bestSoFar = 9999999999999
 *                     knn_pos += 1
 */
          __pyx_t_8 = ((__pyx_v_bestSoFar == 0.0) != 0);
          if (__pyx_t_8) {

            /* "motif_matching_knn.pyx":155
 *                     bestSoFar = nn_dist[knn_pos_plus]
 *                     if bestSoFar == 0 :
 *                         bestSoFar = 9999999999999             # <<<<<<<<<<<<<<
 *                     knn_pos += 1
 *                     knn_pos_plus += 1
 */
            __pyx_v_bestSoFar = 9999999999999.0;
 ...
 *                     knn_pos = knn_pos % knn
 */
          __pyx_v_knn_pos = (__pyx_v_knn_pos + 1);

          /* "motif_matching_knn.pyx":157
 *                         bestSoFar = 9999999999999
 *                     knn_pos += 1
 *                     knn_pos_plus += 1             # <<<<<<<<<<<<<<
 *                     knn_pos = knn_pos % knn
 ...
 */
          __pyx_v_knn_pos_plus = (__pyx_v_knn_pos_plus + 1);

          /* "motif_matching_knn.pyx":158
 *                     knn_pos += 1
 *                     knn_pos_plus += 1
 *                     knn_pos = knn_pos % knn             # <<<<<<<<<<<<<<
 *                     knn_pos_plus = knn_pos_plus % knn
 *                     # nn.append(loc)
 */
          __pyx_v_knn_pos = (__pyx_v_knn_pos % __pyx_v_knn);

          /* "motif_matching_knn.pyx":159
 *                     knn_pos_plus += 1
 *                     knn_pos = knn_pos % knn
 *                     knn_pos_plus = knn_pos_plus % knn             # <<<<<<<<<<<<<<
 *                     # nn.append(loc)
 *                     # if len(nn) > knn:
 */
          __pyx_v_knn_pos_plus = (__pyx_v_knn_pos_plus % __pyx_v_knn);
 ...
 *         if count < length:
 */
        __pyx_t_19 = ((__pyx_v_i + 1) % __pyx_v_m);
        __pyx_v_ex = (__pyx_v_ex - (*((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_19 * __pyx_v_X.strides[0]) ))));

        /* "motif_matching_knn.pyx":167
 *                 # keep the mean and sdev and moving averages.
 *                 ex = ex - X[(i + 1) % m]
 *                 ex2 = ex2 - X[(i + 1) % m] ** 2             # <<<<<<<<<<<<<<
 *         if count < length:
 *             tnext = T[count]
 */
        __pyx_t_20 = ((__pyx_v_i + 1) % __pyx_v_m);
        __pyx_v_ex2 = (__pyx_v_ex2 - pow((*((double *) ( /* dim=0 */ (__pyx_v_X.data + __pyx_t_20 * __pyx_v_X.strides[0]) ))), 2.0));
 ...
 *         else:
 */
    __pyx_t_8 = ((__pyx_v_count < __pyx_v_length) != 0);
    if (__pyx_t_8) {

      /* "motif_matching_knn.pyx":169
 *                 ex2 = ex2 - X[(i + 1) % m] ** 2
 *         if count < length:
 *             tnext = T[count]             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      ...
      __pyx_v_tnext = (*((double *) ( /* dim=0 */ (__pyx_v_T.data + __pyx_t_21 * __pyx_v_T.strides[0]) )));
 ...
 */
  ...
  /* "motif_matching_knn.pyx":174
 *           # print("finished executing")
 *   # print("returning nn")
 *     return nn  #  list of knn positions             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_nn, 0);
  __pyx_r = __pyx_v_nn;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("motif_matching_knn.find_matches", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_nn_dist, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_Q, 1);
  __Pyx_TraceReturn(Py_None, 0);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_18motif_matching_knn_1find_matches(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_18motif_matching_knn_1find_matches(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_T,&__pyx_n_s_Q,&__pyx_n_s_knn,&__pyx_n_s_sample_rate,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_Q)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("find_matches", 0, 3, 4, 1); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_knn)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_matches", 0, 3, 4, 2); __PYX_ERR(0, 78, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_matches") < 0)) __PYX_ERR(0, 78, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_T = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0]); if (unlikely(!__pyx_v_T.memview)) __PYX_ERR(0, 78, __pyx_L3_error)
    __pyx_v_Q = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1]); if (unlikely(!__pyx_v_Q.memview)) __PYX_ERR(0, 78, __pyx_L3_error)
    __pyx_v_knn = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_knn == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 78, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_sample_rate = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_sample_rate == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 78, __pyx_L3_error)
    } else {
      __pyx_v_sample_rate = ((int)1);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("find_matches", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 78, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("motif_matching_knn.find_matches", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_18motif_matching_knn_find_matches(__pyx_self, __pyx_v_T, __pyx_v_Q, __pyx_v_knn, __pyx_v_sample_rate);
...
static PyObject *__pyx_pf_18motif_matching_knn_find_matches(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_T, __Pyx_memviewslice __pyx_v_Q, int __pyx_v_knn, int __pyx_v_sample_rate) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  struct __pyx_opt_args_18motif_matching_knn_find_matches __pyx_t_2;
  PyObject *__pyx_t_3 = NULL;
  __Pyx_RefNannySetupContext("find_matches", 0);
  __Pyx_TraceCall("find_matches (wrapper)", __pyx_f[0], 78, 0, __PYX_ERR(0, 78, __pyx_L1_error));
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_T.memview)) { __Pyx_RaiseUnboundLocalError("T"); __PYX_ERR(0, 78, __pyx_L1_error) }
  if (unlikely(!__pyx_v_Q.memview)) { __Pyx_RaiseUnboundLocalError("Q"); __PYX_ERR(0, 78, __pyx_L1_error) }
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.sample_rate = __pyx_v_sample_rate;
  __pyx_t_1 = __pyx_f_18motif_matching_knn_find_matches(__pyx_v_T, __pyx_v_Q, __pyx_v_knn, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 78, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "motif_matching_knn.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "motif_matching_knn.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "motif_matching_knn.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "motif_matching_knn._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"find_matches", (PyCFunction)__pyx_pw_18motif_matching_knn_1find_matches, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 */
  ...
  __pyx_codeobj__29 = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__35, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_stringsource, __pyx_n_s_pyx_unpickle_Enum, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__29)) __PYX_ERR(2, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initmotif_matching_knn(void); /*proto*/
PyMODINIT_FUNC initmotif_matching_knn(void)
#else
PyMODINIT_FUNC PyInit_motif_matching_knn(void); /*proto*/
PyMODINIT_FUNC PyInit_motif_matching_knn(void)
#endif
{
  __Pyx_TraceDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_motif_matching_knn(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("motif_matching_knn", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_motif_matching_knn) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "motif_matching_knn")) {
      if (unlikely(PyDict_SetItemString(modules, "motif_matching_knn", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("PyMODINIT_FUNC PyInit_motif_matching_knn(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "motif_matching_knn.pyx":2
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init motif_matching_knn", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init motif_matching_knn");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
